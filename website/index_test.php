...
//First two tables
$caption1 = "If you bet $100 on your team to beat the spread each week, how much money would you have right now?";

$table1 = "bigwinners_test.php";
$table2 = "biglosers.php";

//Next two tables
$caption2 = "Vegas doesn't set a line for every game. What teams won the highest percentage of games that did get lines?";

$table3 = "perc_win_best.php";
$table4 = "perc_win_worst.php";

//Final two tables
$caption3 = "Of course, the REAL champs beat the spread while <i>winning</i>";

$table5 = "winning_games.php";
$table6 = "winning_games_abs.php";
